...
// Double couche : escape manuel + DOMPurify comme filet de sécurité

import DOMPurify from 'isomorphic-dompurify'

// ─── DOMPurify configuration ─────────────────────────────────────────────────
// Only allow safe HTML tags generated by our markdown converter
const PURIFY_CONFIG = {
  ALLOWED_TAGS: [
    'p', 'br', 'hr',
    'h2', 'h3', 'h4',
  ...
  ALLOWED_ATTR: ['class'],
  // No URI attributes allowed (no href, src, action, etc.)
 ...
 * Works both server-side (no-op fallback) and client-side.
 */

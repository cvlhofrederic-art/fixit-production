...
export const piscinaRecipes: Recipe[] = [
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    hypothesesACommuniquer: [
      ...
      'Volume betão: ~28 m³ (paredes + laje de fundo)',
      'Armadura bi-nappe HA ∅12 // 15: ~1 000 kg',
    ...
    materials: [
      {
        id: 'betao-c30-piscina-pt', name: 'Betão C30/37 hidrófugo (28 m³)',
        category: 'liant', phase: 'principal', quantityPerBase: 28, unit: 'm3',
      ...
      {
        id: 'armadura-ha12-piscina-pt', name: 'Armadura HA ∅12 bi-nappe (~1 000 kg)',

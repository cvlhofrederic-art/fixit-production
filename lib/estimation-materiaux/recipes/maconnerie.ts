    ...
    materials: [
      {
        ...
        category: 'liant', quantityPerBase: 350, unit: 'kg',
        geometryMultiplier: 'thickness',  // × épaisseur en m
      ...
      },
      {
        ...
        geometryMultiplier: 'none',  // 1 m² de treillis par m² de dalle
      ...
      },
      {
        ...
        geometryMultiplier: 'none',
        wasteFactor: 1.15, wasteReason: 'Recouvrements 20 cm mini + remontées en rives (DTU 13.3)',
        dtu: 'DTU 13.3 § 5.1.4',

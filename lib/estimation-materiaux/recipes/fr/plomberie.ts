...
export const plomberieRecipes: Recipe[] = [
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    geometryMode: 'count',
    dtuReferences: [
      { code: 'NF DTU 60.1 (Décembre 2012 + A1 Décembre 2019)', title: 'Plomberie sanitaire bâtiments' },
      { code: 'NF DTU 60.11 (Août 2013)', title: 'Règles de calcul des installations de plomberie sanitaire et d\'eaux pluviales' },
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    geometryMode: 'length',
    dtuReferences: [
      { code: 'NF DTU 60.5 (Janvier 2008)', title: 'Canalisations en cuivre — distribution d\'eau froide et chaude sanitaire' },
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    geometryMode: 'length',
    dtuReferences: [
      { code: 'NF DTU 60.32 (Novembre 2007)', title: 'Canalisations en PVC non plastifié — évacuation des eaux pluviales' },
      { code: 'NF DTU 60.33 (Octobre 2007)', title: 'Canalisations en PVC non plastifié — évacuation des eaux usées et vannes' },
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    geometryMode: 'count',
    dtuReferences: [
      { code: 'NF DTU 60.1 (Décembre 2012 + A1 Décembre 2019)', title: 'Plomberie sanitaire' },
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    baseUnit: 'u',
    geometryMode: 'count',
    dtuReferences: [{ code: 'NF DTU 60.1 (Décembre 2012 + A1 Décembre 2019)', title: 'Plomberie sanitaire' }],
    version: '2.1.0',
    hypothesesACommuniquer: [
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    dtuReferences: [
      { code: 'NF DTU 60.1 (Décembre 2012 + A1 Décembre 2019)', title: 'Plomberie sanitaire' },
      { code: 'NF DTU 52.2 P1-1-4 (Mai 2022)', title: 'SPEC — Système de Protection à l\'Eau sous Carrelage (douche italienne)' },
    ],
    version: '2.1.0',
    hypothesesACommuniquer: [
      ...
      'Membrane SPEC obligatoire pour douche à l\'italienne (NF DTU 52.2 P1-1-4, Mai 2022)',
    ...
    materials: [
      ...
      {
        id: 'primaire-spec-douche', name: 'Primaire d\'accrochage SPEC (support poreux)',
        category: 'primaire', phase: 'preparation', quantityPerBase: 0.3, unit: 'L', geometryMultiplier: 'none',
        wasteFactor: 1.10, wasteReason: 'Application rouleau',
        dtu: 'NF DTU 52.2 P1-1-4 (Mai 2022)',
        manufacturerRef: 'Mapei Primer G / Weber.prim universel',
        notes: 'Préparation obligatoire avant membrane SPEC sur chape/dalle béton.',
      },
      {
        id: 'bande-etancheite-angle-spec', name: 'Bande d\'étanchéité angles + jonction bonde',
        category: 'etancheite', phase: 'preparation', quantityPerBase: 5, unit: 'ml', geometryMultiplier: 'none',
        wasteFactor: 1.10, wasteReason: 'Coupes aux angles',
        dtu: 'NF DTU 52.2 P1-1-4',
        manufacturerRef: 'Mapei Mapeband / Weber.sys Protect bande',
        notes: 'Bandes butyl/acrylique aux angles paroi-sol + autour bonde (pénétrations).',
      },
      {
        id: 'siphon-bonde-douche', name: 'Siphon sortie verticale Ø40 (sous bonde)',
        category: 'accessoire', phase: 'accessoires', quantityPerBase: 1, unit: 'u', geometryMultiplier: 'none',
        wasteFactor: 1.00, wasteReason: 'Pas de perte',
        dtu: 'NF DTU 60.1 (Décembre 2012 + A1 Décembre 2019)',
        manufacturerRef: 'Wirquin / Nicoll',
        notes: 'Hauteur siphon adaptée à l\'espace sous receveur (extra-plat = siphon ultra-plat).',
      },
      {
        id: 'chape-pente-receveur', name: 'Chape/mortier de pente sous receveur (1,5%)',
        category: 'enduit', phase: 'preparation', quantityPerBase: 8, unit: 'kg', geometryMultiplier: 'none',
        wasteFactor: 1.10, wasteReason: 'Résidus + surface irrégulière',
        dtu: 'NF DTU 52.2 P1-1-4',
        manufacturerRef: 'Weber.niv pro / Mapei Ultraplan',
        notes: 'Forme de pente 1,5% vers bonde — obligatoire sous receveur extra-plat ou douche maçonnée.',
      },
    ],
  },
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    geometryMode: 'count',
    dtuReferences: [
      { code: 'NF DTU 60.1 (Décembre 2012 + A1 Décembre 2019)', title: 'Plomberie sanitaire', section: '§6.4 groupe sécurité' },

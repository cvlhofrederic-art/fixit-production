...
export const peintureRecipes: Recipe[] = [
...

  {
    ...
    dtuReferences: [
      { code: 'NF DTU 59.1 (Juin 2013)', title: 'Travaux de peinture des bâtiments', section: 'Classe C - travaux courants' },
    ],
    version: '2.1.0',
...

  {
    ...
    baseUnit: 'm2',
    geometryMode: 'area_minus_openings',
    dtuReferences: [{ code: 'NF DTU 59.1 (Juin 2013)', title: 'Travaux de peinture - entretien' }],
    version: '2.0.0',
    materials: [
      {
...

  {
    ...
    baseUnit: 'm2',
    geometryMode: 'area',
    dtuReferences: [{ code: 'NF DTU 59.1 (Juin 2013)', title: 'Travaux de peinture - plafonds' }],
    version: '2.0.0',
    materials: [
      {
...

  {
    ...
    baseUnit: 'm2',
    geometryMode: 'area',
    dtuReferences: [{ code: 'NF DTU 59.1 (Juin 2013)', title: 'Peinture - travaux sur bois' }],
    version: '2.0.0',
    materials: [
      {

...
export const maconnerieRecipes: Recipe[] = [
...

  {
    ...
    materials: [
      ...
      {
        id: 'fourreau-irl-20', name: 'Fourreau IRL Ø20 (passage élec sous dalle)',
        ...
        optional: true,
        condition: 'Si alimentation élec transite sous dalle (garage, atelier, cuisine îlot)',
      },
      {
        id: 'evac-pvc-100-sortie-dalle', name: 'Tube PVC Ø100 évacuation (traversée dalle)',
        category: 'accessoire', phase: 'preparation', quantityPerBase: 0.1, unit: 'ml',
        geometryMultiplier: 'none',
        wasteFactor: 1.10, wasteReason: 'Coupes + manchons',
        dtu: 'NF DTU 60.33 (Janvier 2007)',
        manufacturerRef: 'Nicoll / Girpi',
        optional: true,
        condition: 'Si sortie évacuation WC/évier prévue dans la dalle (SDB, cuisine, garage)',
      },
      {
        id: 'ceinturage-malt-cuivre-25', name: 'Ceinturage mise à la terre cuivre nu 25 mm² (fondation)',
        category: 'accessoire', phase: 'preparation', quantityPerBase: 1.2, unit: 'ml',
        geometryMultiplier: 'perimeter',
        wasteFactor: 1.10, wasteReason: 'Coupes + raccords bornes',
        normRef: 'NF C 15-100 §542.2 (MALT fond de fouille)',
        manufacturerRef: 'Nexans / Acome',
        packaging: { unit: 'rouleau', contentQty: 50, contentUnit: 'ml', label: 'couronne 50 ml' },
        optional: true,
        condition: 'Logement neuf : MALT fond de fouille obligatoire (NF C 15-100 §542)',
      },
      {
        id: 'coffrage-peripherique-planche', name: 'Coffrage périphérique (planche sapin 27 mm)',
        category: 'bois', phase: 'preparation', quantityPerBase: 1, unit: 'ml',
        geometryMultiplier: 'perimeter',
        wasteFactor: 1.15, wasteReason: 'Réutilisable 2-3×, coupes, casse',
        dtu: 'NF DTU 21 (Mars 2017)',
        notes: 'Planche d\'arrêt périmétrique pour coulage dalle. Réutilisable.',
      },
      {
        id: 'chainage-peripherique-dalle', name: 'Chaînage périphérique 4 HA10 (rive dalle)',
        category: 'acier', phase: 'principal', quantityPerBase: 2, unit: 'kg',
        geometryMultiplier: 'perimeter',
        wasteFactor: 1.10, wasteReason: 'Chutes + recouvrements 30 cm',
        dtu: 'NF DTU 13.3 §5.3',
        normRef: 'NF A 35-080-1 (Janvier 2013)',
        notes: 'Armature continue en rive (2 kg/ml × périmètre). Obligatoire si dallage chargé.',
      },
    ],
  },

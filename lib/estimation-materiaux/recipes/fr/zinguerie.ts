...
export const zingerieRecipes: Recipe[] = [
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    geometryMode: 'length',
    dtuReferences: [
      { code: 'NF DTU 40.5', title: 'Évacuation eaux pluviales', section: '§5-6' },
    ],
    version: '2.1.0',
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    geometryMode: 'length',
    dtuReferences: [
      { code: 'NF DTU 40.5', title: 'Évacuation EP' },
      { code: 'NF DTU 60.11', title: 'Dimensionnement (Ø80 < 50 m² / Ø100 > 50 m²)' },
    ],
    version: '2.1.0',
    hypothesesACommuniquer: [
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    geometryMode: 'length',
    dtuReferences: [
      { code: 'NF DTU 40.21', title: 'Tuiles TC', section: '§6.7 noues' },
      { code: 'NF DTU 40.41', title: 'Zinc', section: '§7 noues' },
    ],
    version: '2.1.0',
    hypothesesACommuniquer: [
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    dtuReferences: [
      { code: 'NF DTU 40.5', title: 'Évacuation EP' },
      { code: 'NF DTU 40.41', title: 'Zinc joint debout / solins' },
    ],
    version: '2.1.0',
    hypothesesACommuniquer: [

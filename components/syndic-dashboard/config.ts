...
export const ROLE_PAGES: Record<string, Page[]> = {
  ...
  syndic_secretaire: ['accueil', 'coproprios', 'immeubles', 'artisans', 'missions', 'canal', 'planning', 'rapport', 'documents', 'extranet', 'ag_digitale', 'sinistres', 'carnet_entretien', 'urgences', 'declaracao_encargos', 'preparateur_ag', 'alertes', 'emails', 'ia', 'parametres', 'modules', 'votacao_online', 'portal_condomino', 'enquetes', 'quadro_avisos', 'atas_ia', 'whatsapp_condominos', 'reserva_espacos', 'vote_correspondance', 'extranet_enrichi', 'sondages_fr', 'panneau_affichage', 'pv_assemblee_ia', 'communication_demat', 'reservation_espaces_fr', 'relatorio_gestao', 'preparador_assembleia', 'chatbot_whatsapp', 'fixy_agent', 'max_agent', 'alfredo_agent', 'automation_agent'],

...
function renderModule(route: string, navigate: (id: string) => void): ReactNode {
  ...
  if (route === 'contratos') return <ModContratos />
  ...
  if (route === 'modulos') return <ModOsMeusModulos />
  if (route === 'pontuacao') return <ModPontuacao />
  if (route === 'certEnerg') return <ModCertEnerg />
  if (route === 'declEncargos') return <ModDeclEncargos />
  ...
  if (route === 'whatsapp') return <ModWhatsapp />
  if (route === 'ocorrencias') return <ModOcorrencias />
  ...
  if (route === 'caderneta') return <ModCadernetaMan />

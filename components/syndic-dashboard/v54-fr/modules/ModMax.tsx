...
// NB : le mockup passe alert kind 'info', classe inexistante dans son CSS
// (rendu = défaut amber) ; la primitive PT n'a pas de kind 'info' → kind omis
// (défaut amber), rendu identique.
...
export default function ModMax() {
  ...
  return (
    <AgentChatPage
      ...
      alert={{ icon: 'scale', title: "Réponses fondées sur la loi du 10 juillet 1965 et le décret du 17 mars 1967 — à vérifier au regard de l'ordonnance." }}

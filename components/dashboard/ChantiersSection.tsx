  ...
  if (selected) {
    ...
    return (
      <div className={isV5 ? 'v5-fade' : 'space-y-3 font-[family-name:var(--font-dm-sans)]'}>
        ...
        {/* Back + header */}
        <div className={isV5 ? '' : 'flex items-center gap-3'} style={{ marginBottom: '1.1rem' }}>
  ...
  return (
    <div className={isV5 ? 'v5-fade' : 'space-y-3 font-[family-name:var(--font-dm-sans)]'}>
      ...
      <div style={{ marginBottom: '1.1rem' }}>
        <h1 className={isV5 ? '' : 'text-lg font-semibold'} style={isV5 ? { fontSize: 18, fontWeight: 600, marginBottom: 2 } : { color: tv.text }}>Chantiers</h1>
        {isV5 && <p style={{ fontSize: 12, color: '#999', margin: 0 }}>Suivi de vos chantiers en cours, à venir et clôturés</p>}
      </div>

  ...
  return (
    <div>
      <div className={isV5 ? '' : 'v22-page-header'} style={{ marginBottom: '1.1rem' }}>
        <div>
          {isV5 ? <h1 style={{ fontSize: 18, fontWeight: 600, marginBottom: 2 }}>{t('proDash.btp.retenues.title')}</h1> : <h1 className="v22-page-title">{t('proDash.btp.retenues.title')}</h1>}
          {isV5 ? <p style={{ fontSize: 12, color: '#999', margin: 0 }}>{t('proDash.btp.retenues.subtitle')}</p> : <p className="v22-page-sub">{t('proDash.btp.retenues.subtitle')}</p>}
        </div>

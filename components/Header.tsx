      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link
              href="/recherche"
              className="text-gray-600 hover:text-[#FFC107] transition font-medium"
            >
              Trouver un artisan
            </Link>
            <Link
            ...
            {!user ? (
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 bg-[#FFC107] hover:bg-[#FFD54F] text-gray-900 pl-3 pr-4 py-2 rounded-lg font-semibold transition"
                >
          ...
          <div className="md:hidden pb-4 space-y-3 border-t border-gray-100 pt-3">
            ...
            {!user ? (
              <>
                ...
                <Link
                  href="/auth/login"
                  className="block bg-[#FFC107] hover:bg-[#FFD54F] text-gray-900 px-6 py-2.5 rounded-lg font-semibold transition text-center"
                  onClick={() => setMenuOpen(false)}
                >
                  Se connecter
                </Link>

...
/**
 * WhatsAppFloatingButton — bouton fixe bas-droit sur toutes les pages publiques.
 * FR : +33 6 34 46 88 97 (uniquement WhatsApp)
 * PT/autres : +351 912 014 971
 */
export default function WhatsAppFloatingButton() {
  ...
  return (
    ...
    >
      ...
      {/* Label visible sur tablette/desktop uniquement */}
      <span className="font-semibold text-[0.88rem] leading-none hidden sm:block whitespace-nowrap">
        WhatsApp
      </span>
    </a>
  )

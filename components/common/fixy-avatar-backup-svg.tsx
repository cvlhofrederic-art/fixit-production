// BACKUP — Ancien avatar SVG de Fixy (robot doré avec clé à molette)
// Pour rollback : copier cette fonction dans RobotAvatars.tsx à la place de la version img

export function FixyAvatarSVG({ size = 40 }: { size?: number }) {
  return (

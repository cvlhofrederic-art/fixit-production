...
module.exports = {
  ci: {
    ...
    assert: {
      // LHCI exige `assertions` OU `assertMatrix`, pas les deux.
      // On utilise `assertMatrix` avec les patterns spécifiques d'abord
      // (ordre = first-match-wins) et un catch-all `.*` final pour
      // appliquer les seuils globaux par défaut.

...
export const metadata: Metadata = {
  title: 'Privacy Policy | Vitfix',
  robots: { index: false, follow: true },
  alternates: { canonical: 'https://vitfix.io/en/privacy/' },
}
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 space-y-6">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">{t('privacy.collection.p1')}</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">{t('privacy.usage.title')}</h2>
            <p className="text-gray-600 leading-relaxed">{t('privacy.usage.intro')}</p>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">{t('privacy.protection.p1')}</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">{t('privacy.rights.title')}</h2>
            <p className="text-gray-600 leading-relaxed">{t('privacy.rights.intro')}</p>
            <ul className="list-disc list-inside text-gray-600 mt-2 space-y-1">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">{t('privacy.cookies.p1')}</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">{t('privacy.retention.title')}</h2>
            <p className="text-gray-600 leading-relaxed">{t('privacy.retention.p1')}</p>
          </section>

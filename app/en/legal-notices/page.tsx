...
export const metadata: Metadata = {
  title: 'Legal Notices | Vitfix',
  robots: { index: false, follow: true },
  alternates: { canonical: 'https://vitfix.io/en/legal-notices/' },
}
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-500 text-sm mb-8">{t('legal.subtitle')}</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><strong>Phone :</strong> +1 (650) 319-8930</li>
              ...
              <li><strong>EU representative (GDPR art. 27) :</strong> Cloudflare Ireland Ltd, 25/28 North Wall Quay, Dublin 1, Ireland</li>
            </ul>
          </section>

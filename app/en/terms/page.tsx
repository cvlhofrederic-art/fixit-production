...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Vitfix',
  robots: { index: false, follow: true },
  alternates: { canonical: 'https://vitfix.io/en/terms/' },
}
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">{t('cgu.title')}</h1>
        <p className="text-gray-500 text-sm mb-8">{t('cgu.lastUpdate')}</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>{t('cgu.preamble.p1')}</p>
            <p className="mt-3">{t('cgu.preamble.p2')}</p>

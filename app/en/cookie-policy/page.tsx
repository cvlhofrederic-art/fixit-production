...
export const metadata: Metadata = {
  title: 'Cookie Policy | Vitfix',
  robots: { index: false, follow: true },
  alternates: { canonical: 'https://vitfix.io/en/cookie-policy/' },
}
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">{t('cookies.what.p1')}</p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="border border-green-200 bg-green-50 rounded-xl p-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">{t('cookies.necessary.desc')}</p>
              ...
              <div className="border border-gray-200 rounded-xl p-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">{t('cookies.performance.desc')}</p>
              </div>
              ...
              <div className="border border-gray-200 rounded-xl p-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">{t('cookies.personalization.desc')}</p>
              </div>
              ...
              <div className="border border-gray-200 rounded-xl p-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">{t('cookies.advertising.desc')}</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mb-3">{t('cookies.rights.p1')}</p>
            <p className="text-gray-600 leading-relaxed mb-3">{t('cookies.rights.p2')}</p>
            ...
            <p className="text-gray-500 text-sm mt-3">{t('cookies.rights.warning')}</p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              <a href="mailto:contact@vitfix.io" className="text-yellow hover:underline">contact@vitfix.io</a>
            </p>
          </section>
        </div>
      </div>

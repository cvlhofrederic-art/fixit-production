...
import { ES_INVESTOR_PAGES } from '@/lib/data/investor-pages-data'
import EmergencyBlock from '@/components/en/EmergencyBlock'
import { PHONE_PT } from '@/lib/constants'

export const metadata: Metadata = {
  title: 'Servicios para Viviendas en Oporto | Para Inversores Espa\u00f1oles | VITFIX',
  description: 'Reformas, fontaner\u00eda, electricista y mantenimiento para inversores espa\u00f1oles en Oporto. Profesionales verificados, presupuesto gratis, seguimiento a distancia.',
  openGraph: {
...
export default function EsHubPage() {
  const jsonLd = {
    ...
    '@graph': [
      {
        '@type': 'CollectionPage',
        name: 'Servicios para Viviendas en Oporto - VITFIX',
        description: 'Reformas, fontaner\u00eda, electricista y mantenimiento para inversores espa\u00f1oles en Oporto.',
        url: 'https://vitfix.io/es/',
        inLanguage: 'es',
      },
      {
        '@type': 'BreadcrumbList',
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'VITFIX', item: 'https://vitfix.io/es/' },
        ],
      },
    ],
  }
  ...
  return (
    <div className="min-h-screen bg-warm-gray">
      ...
      <section className="pt-16 pb-12 md:pt-20 md:pb-16" style={{ background: 'linear-gradient(135deg, rgba(255,214,0,0.08) 0%, #fff 40%, #F5F3EF 100%)' }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-yellow/10 border border-yellow/25 text-sm font-semibold mb-4">
            <span>{'\ud83c\uddea\ud83c\uddf8'}</span>
            <span className="text-dark">Servicio en Espa\u00f1ol</span>
          </div>

          <h1 className="font-display text-[clamp(2rem,4.5vw,3.2rem)] font-extrabold tracking-tight leading-[1.1] text-dark mb-4">
            Servicios para Viviendas en Oporto
          </h1>
          <p className="text-lg text-text-muted max-w-2xl leading-relaxed mb-6">
            Profesionales verificados para reformas, fontaner&iacute;a, electricidad y mantenimiento de su propiedad en Oporto. Servicio adaptado para inversores espa&ntilde;oles.
          </p>
          ...
          <div className="flex flex-wrap gap-4 text-sm">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-text-muted">(127 valoraciones)</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span>&#9989;</span>
              <span className="text-text-muted">Profesionales verificados</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span>&#9201;</span>
              <span className="text-text-muted">Respuesta &lt; 30 min</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 md:py-18">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-text-muted mb-8 max-w-2xl">
            Seleccione un servicio para m&aacute;s informaci&oacute;n y un presupuesto gratis de profesionales verificados.
          </p>
            ...
            {ES_INVESTOR_PAGES.map(page => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border/30">
                  <span className="text-sm font-semibold text-yellow">Presupuesto gratis</span>
      ...
      <section className="py-14 md:py-18 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <EmergencyBlock serviceType="home repair" locale="es" />
        </div>
      </section>
      ...
      <section className="py-14 md:py-18">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-text-muted mb-8 max-w-2xl">
            Servimos toda la zona metropolitana de Oporto y alrededores.
          </p>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display text-[clamp(1.5rem,3vw,2.2rem)] font-extrabold tracking-tight mb-4">
            Solicite un Presupuesto Gratis Hoy
          </h2>
          <p className="text-text-muted mb-8 max-w-md mx-auto">
            Describa lo que necesita y reciba un presupuesto sin compromiso de profesionales verificados en 24 horas.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/es/reformas-apartamento-oporto/"
            ...
            <a
              href={`https://wa.me/${PHONE_PT.replace('+', '')}?text=Hola%20VITFIX%2C%20necesito%20ayuda%20con%20mi%20propiedad%20en%20Oporto`}
              target="_blank"

...
const PRIMITIVES: PrimitiveLink[] = [
  ...
  { slug: 'form-row', label: 'FormRow', batch: 3, ready: false },
  { slug: 'panel', label: 'Panel', batch: 4, ready: false },
  { slug: 'kpi', label: 'KPI / KPIGrid', batch: 4, ready: false },
  { slug: 'empty', label: 'Empty', batch: 4, ready: false },
  { slug: 'alert', label: 'Alert', batch: 4, ready: false },
  { slug: 'page-head', label: 'PageHead', batch: 4, ready: false },
  { slug: 'tabs', label: 'Tabs', batch: 5, ready: false },

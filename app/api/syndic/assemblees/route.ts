...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('[syndic/assemblees/GET] Unexpected error:', err)
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error('[syndic/assemblees/POST] Unexpected error:', err)
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
  }
}
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    logger.error('[syndic/assemblees/PATCH] Unexpected error:', err)
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    logger.error('[syndic/assemblees/DELETE] Unexpected error:', err)
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
  }
}

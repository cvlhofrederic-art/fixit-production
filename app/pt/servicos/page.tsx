  ...
  return (
    <div className="min-h-screen bg-warm-gray">
      ...
      {SERVICES.map(service => (
        <section key={service.slug} className="py-12 md:py-16 even:bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-text-muted mb-8 max-w-2xl">{service.heroSubtitle.replace(/\{city\}/g, 'a sua zona')}</p>
      ...
      <section className="py-12 md:py-16 bg-warm-gray">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-xl font-extrabold tracking-tight text-dark mb-6 text-center">Descubra também</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/pt/condominio/" className="bg-white rounded-xl p-4 text-center hover:shadow-md transition no-underline">
              <span className="text-2xl">🏢</span>
              <p className="text-sm font-semibold text-dark mt-2">Condomínios</p>
            </Link>
            <Link href="/pt/especialidades/" className="bg-white rounded-xl p-4 text-center hover:shadow-md transition no-underline">
              <span className="text-2xl">⭐</span>
              <p className="text-sm font-semibold text-dark mt-2">Especialidades</p>
            </Link>
            <Link href="/pt/simulador-orcamento/" className="bg-white rounded-xl p-4 text-center hover:shadow-md transition no-underline">
              <span className="text-2xl">🧮</span>
              <p className="text-sm font-semibold text-dark mt-2">Simulador de orçamento</p>
            </Link>
            <Link href="/pt/precos/" className="bg-white rounded-xl p-4 text-center hover:shadow-md transition no-underline">
              <span className="text-2xl">💰</span>
              <p className="text-sm font-semibold text-dark mt-2">Tabela de preços</p>
            </Link>
          </div>
        </div>
      </section>

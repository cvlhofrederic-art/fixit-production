...
const MobileHomeSection = dyn(() => import('@/components/pro-mobile/pages/MobileHomeSection'))
    ...
    <div className="min-h-screen bg-[#F8F9FA] pb-20 safe-area-pt" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      {activeTab === 'home' && (
        <MobileHomeSection
          ...
          artisanNotifs={artisanNotifs}
          serviceRanges={serviceRanges}
          isModuleEnabled={isModuleEnabled}
          setActiveTab={setActiveTab}
          setShowNewRdv={setShowNewRdv}
      ...
      {activeTab === 'documents' && (
        <MobileDocumentsSection
          ...
          copyComplianceProfile={copyComplianceProfile}
          complianceCopied={complianceCopied}
          setDevisForm={setDevisForm}
          setDevisGenere={setDevisGenere}
      ...
      {activeTab === 'settings' && (
        <MobileSettingsSection
          ...
          DAY_NAMES={DAY_NAMES}
          MobilePasswordChange={MobilePasswordChange}
        />
      )}
